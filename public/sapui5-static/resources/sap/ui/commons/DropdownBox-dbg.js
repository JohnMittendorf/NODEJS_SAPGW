...
sap.ui.commons.DropdownBox.getMetadata()._mHiddenAggregations = sap.ui.commons.ComboBox.getMetadata()._mHiddenAggregations;
...
sap.ui.commons.DropdownBox.prototype.setListBox = function(sListBox) {

	var oOldListBox = this._getListBox();
	if (oOldListBox) {
		oOldListBox.detachEvent("itemsChanged", this._handleItemsChanged, this);
	}

	sap.ui.commons.ComboBox.prototype.setListBox.apply(this, arguments);

	if (sListBox) {
		sListBox.attachEvent("itemsChanged",this._handleItemsChanged, this);
	}

	return this;
};

sap.ui.commons.DropdownBox.prototype._getPrivateListBox = function(){

	var bNew = !this._oListBox;

	sap.ui.commons.ComboBox.prototype._getPrivateListBox.apply(this, arguments);
...
sap.ui.commons.DropdownBox.prototype.setMaxHistoryItems = function(iMaxHistoryItems) {
	...
	if (iMaxHistoryItems < iOldMaxHistoryItems) {
		...
		for ( var i = iMaxHistoryItems; i < iOldMaxHistoryItems; i++) {
