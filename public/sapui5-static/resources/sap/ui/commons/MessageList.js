 ...
 */
jQuery.sap.declare("sap.ui.commons.MessageList");jQuery.sap.require("sap.ui.commons.library");jQuery.sap.require("sap.ui.core.Control");sap.ui.core.Control.extend("sap.ui.commons.MessageList",{metadata:{publicMethods:["setMessages"],library:"sap.ui.commons",properties:{"visible":{type:"boolean",group:"Behavior",defaultValue:false},"anchorId":{type:"string",group:"Appearance",defaultValue:null},"maxListed":{type:"string",group:"Misc",defaultValue:'7'}}}});jQuery.sap.require("sap.ui.core.Popup");
...
sap.ui.commons.MessageList.prototype.onAfterRendering=function(){var l=this.getDomRef();var j=jQuery(l);var m=this.getMaxListed();var a=this.aMessages.length;if(a<=m){j.height("auto");return;}if(this.iItemHeight==0){var i=l.firstChild;var b=jQuery(i);this.iItemHeight=b.height();}l.style.overflowY="scroll";l.style.overflowX="hidden";var d=(m*this.iItemHeight)+"px";j.height(d);};
