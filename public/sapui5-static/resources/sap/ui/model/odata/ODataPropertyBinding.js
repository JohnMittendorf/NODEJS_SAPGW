...
sap.ui.model.odata.ODataPropertyBinding.prototype.setValue=function(v){if(this.oValue!=v){if(this.oModel.setProperty(this.sPath,v,this.oContext)){this.oValue=v;}else{this._fireChange();}}};
sap.ui.model.odata.ODataPropertyBinding.prototype.setContext=function(c){this.oContext=c;this.checkUpdate();};
sap.ui.model.odata.ODataPropertyBinding.prototype.checkUpdate=function(){var v=this._getValue();if(v!==this.oValue){this.oValue=v;this._fireChange();}};
