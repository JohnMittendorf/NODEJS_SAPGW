 ...
 */
jQuery.sap.declare("sap.ui.model.resource.ResourceModel");jQuery.sap.require("sap.ui.model.Model");jQuery.sap.require("sap.ui.model.resource.ResourcePropertyBinding");
sap.ui.model.resource.ResourceModel=function(d){sap.ui.model.Model.apply(this,arguments);this.sDefaultBindingMode=sap.ui.model.BindingMode.OneTime;this.mSupportedBindingModes={"OneWay":false,"TwoWay":false,"OneTime":true};if(d&&(d.bundleUrl||d.bundleName)){this.ResourceBundle=this.loadResourceBundle(d);}else{throw new Error("Neither url nor library name are given. One of these is mandatory.");}};
sap.ui.model.resource.ResourceModel.prototype=jQuery.sap.newObject(sap.ui.model.Model.prototype);sap.ui.base.Object.defineClass("sap.ui.model.resource.ResourceModel",{baseType:"sap.ui.model.Model",publicMethods:["getResourceBundle"]});
