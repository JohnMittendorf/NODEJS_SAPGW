...
sap.ui.base.Object.defineClass=function(c,s,F){var m=new(F||sap.ui.base.Metadata)(c,s);var f=m.getClass();f.getMetadata=f.prototype.getMetadata=jQuery.sap.getter(m);if(!m.isFinal()){f.extend=function(a,o,b){return sap.ui.base.Metadata.createClass(f,a,o,b||F);};}jQuery.sap.log.debug("defined class '"+c+"'"+(m.getParent()?" as subclass of "+m.getParent().getName():""));return m;};
