...
sap.ui.core.Locale = function(sLocaleId) {
	...
	var aResult = sap.ui.core.Locale.rLocale.exec(sLocaleId.replace(/_/g, "-"));
...
sap.ui.base.Object.defineClass("sap.ui.core.Locale", {
	baseType : "sap.ui.base.Object",
	publicMethods : ["getLanguage", "getScript", "getRegion", "getVariant", "getExtension", "getPrivateUse", "hasPrivateUseSubtag", "toString"]
});
 ...
 */
sap.ui.core.Locale.rLocale=/^((?:[A-Z]{2,3}(?:-[A-Z]{3}){0,3})|[A-Z]{4}|[A-Z]{5,8})(?:-([A-Z]{4}))?(?:-([A-Z]{2}|[0-9]{3}))?(-[0-9A-Z]{5,8}|(?:[0-9][0-9A-Z]{3}))*(?:-([0-9A-WYZ](?:-[0-9A-Z]{2,8})+))*(?:-(X(?:-[0-9A-Z]{1,8})+))?$/i;
 ...
 * @public
 */
sap.ui.core.Locale.prototype.getLanguage = function() {
 ...
 * @public
 */
sap.ui.core.Locale.prototype.getScript = function() {
	return this.sScript;
};
 ...
 * @public
 */
sap.ui.core.Locale.prototype.getRegion = function() {
	return this.sRegion;
};
 ...
 * @public
 */
sap.ui.core.Locale.prototype.getVariant = function() {
 ...
 * @public
 */
sap.ui.core.Locale.prototype.getVariantSubtags = function() {
 ...
 * @public
 */
sap.ui.core.Locale.prototype.getExtension = function() {
 ...
 * @public
 */
sap.ui.core.Locale.prototype.getExtensionSubtags = function() {
 ...
 * @public
 */
sap.ui.core.Locale.prototype.getPrivateUse = function() {
 ...
 * @public
 */
sap.ui.core.Locale.prototype.getPrivateUseSubtags = function() {
	return this.sPrivateUse ? this.sPrivateUse.slice(2).split('-') : [];
};

sap.ui.core.Locale.prototype.hasPrivateUseSubtag = function(sSubtag) {
...
sap.ui.core.Locale.prototype.toString = function() {
