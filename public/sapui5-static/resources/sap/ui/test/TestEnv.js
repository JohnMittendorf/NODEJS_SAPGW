...
sap.ui.test.TestEnv.prototype.onControlEvent=function(e){if(this.oCore.isLocked()){var b=e.getParameter("browserEvent");if(b.type=="click"){var o=b.srcControl;if(o){var s=new sap.ui.debug.Highlighter('sap-ui-testsuite-SelectionHighlighter');s.highlight(o.getDomRef());if(selectControl){selectControl(o.getId());}}}}};
