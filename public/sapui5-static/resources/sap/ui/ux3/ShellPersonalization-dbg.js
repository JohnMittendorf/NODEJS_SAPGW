...
if (jQuery.browser.mozilla) {
	sap.ui.ux3.ShellPersonalization.ORIGINAL_SETTINGS.sBgCssImg = "-moz-linear-gradient(top, #606366 0, #2C2C2C 110px, #2C2C2C)";
	...
	sap.ui.ux3.ShellPersonalization.ORIGINAL_SETTINGS.sBgCssImg = "url("
		...
		sap.ui.ux3.ShellPersonalization.ORIGINAL_SETTINGS.sBgCssImg = "-ms-linear-gradient(top, #606366 0, #2C2C2C 110px, #2C2C2C)";
	}
} else if (jQuery.browser.webkit) {
	sap.ui.ux3.ShellPersonalization.ORIGINAL_SETTINGS.sBgCssImg = "-webkit-linear-gradient(top, #606366 0, #2C2C2C 110px, #2C2C2C)";
}
